...
function Home() {
  ...
  async function handleSearch(e) {
    console.log("search clicked", username);
          ...
          <section className="side-bar">
            ...
            <div className="feed">
              <div className="search-container">
                ...
                {err && seachUser === null? (<div className="text-secondary">User not found</div>) : ""}
                {seachUser && (
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">Are you sure you want to quit?</div>
